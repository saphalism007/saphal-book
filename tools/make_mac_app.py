#!/usr/bin/env python3
"""
Build the Mac application, so Chartered Book can be opened by clicking an icon.

    python3 tools/make_mac_app.py

It writes "Chartered Book.app" beside this project. Drag that to the
...
def main():
    ...
    with open(launcher, "w", encoding="utf-8") as handle:
        handle.write(
            '#!/bin/bash\n'
            '# Opens Chartered Book.\n'
            '# The software sits inside this app, in Contents/Resources/app.\n'
            '# The books are kept in Library/Application Support/Chartered Book.\n'
            ...
            'free from python.org and open Chartered Book again." with title "Chartered Book" '
    ...
    info = {
        ...
        "NSDocumentsFolderUsageDescription":
            "Chartered Book keeps your books in this folder.",
    ...
    print()
    print("  Double click it to open Chartered Book.")
