# Putting Chartered Book on a Windows computer
...
2. Copy the whole **Chartered Book** folder onto the computer. Somewhere
   sensible, such as `C:\Chartered Book`. Do not put it in OneDrive, because
...
3. Open the folder and double click **Chartered Book.vbs**. The browser opens
   at the books. No black console window appears.

4. Right click **Chartered Book.vbs**, choose **Send to**, then **Desktop
...
Open Chartered Book, then in Edge or Chrome open the menu and choose
**Install Chartered Book** or **Apps, Install this site as an app**. It then
...
The books are kept in:
    ...
    C:\Users\<your name>\AppData\Local\Chartered Book
...
Chartered Book keeps running quietly after you close the browser, so it is
