...
**On this Mac.** Double click **Chartered Book** (the icon with the ledger
...
double click **Chartered Book.vbs**. No black console window appears. Right
click it and Send to Desktop to make a shortcut.

**On a phone or tablet.** Open **Use on your phone** inside Chartered Book. It
...
the books over your own wifi, so this computer has to be on and Chartered Book
...
On Windows it is `C:\Users\<your name>\AppData\Local\Chartered Book`.
...
`~/Library/Application Support/Chartered Book/chartered-book.log`. The last few
